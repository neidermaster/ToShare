...
$codVeri=$_SESSION["codigoverificacion"];
if (!$codVeri){
...
<table width="100%"  border="0" cellspacing="5" cellpadding="0">
    <tr>
        <td class="titulos2" ALIGN=CENTER >
            <FONT SIZE=2>INFORMACION DEL DOCUMENTO CON NUMERO DE RADICADO 
                <?
                $isql = "select radi_path from radicado r 
    ...
    <table width="100%"  border="0" cellspacing="5" cellpadding="0">
                        ...
                        <td>
                            <table width="100%"  border="0" cellspacing="5" cellpadding="0">
                                <tr>
                                    ...
                                    <td class="listado2">
                                        <? $isql = "select d.depe_nomb from radicado r 
        ...
        <!-- ESTA tABLA MUESTRA EL ESTADO ACTUAL DEL DOCUMENTO EN TEXTO Y EN GRAFICO -->
    <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="borde_tab">
        <td>
            <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="borde_tab">
                <tr>
                            ...
                            <tr>
                                ...
                                <td class="listado2"> 
                                    <? $isql = "select a.SGD_FLD_CODIGO,
                                                 ...
                                                 where a.sgd_tpr_codigo=b.SGD_TPR_CODIGO
        ...
        <table  class="borde_tab"  width="99%" align="center">
            <tr  class="titulo1" align="center">
                <td width=10% height="24">
                    Tipo</td>
                <td width=10% height="24">RADICADO</td>
                <td  width=15%  height="24">FECHA </td>
                <td  width=15% height="24" >Asunto</td>
            ...
            <tr class='listado2'>
                ...
                <td><?=$rs->fields["RADI_FECH_RADI"]?></td>
                <td><?=$rs->fields["RA_ASUN"] ?> </td>
                <td><?=$verImagen?> </td>
            </tr>
                <?$rs->MoveNext();
                } //Cierra While
                    ...
                    <table  width="99%" class="borde_tab" align="center">
                        <tr class='titulo1' align="center">
                            <td width=10%  height="24">RADICADO</td>
                                ...
                                FECHA </td>-->
                            <td  width=15% height="24">Destinatario</td>
                            <!--    <td  width=15%  height="24" >
                                  DIRECCION</td>-->
                            <td  width=15% height="24">DEPARTAMENTO </td>
                            <td  width=15% height="24">MUNICIPIO</td>
                            <td  width=15%  height="24">TIPO DE ENVIO</td>
                            <td  width=5% height="24">No. PLANILLA</td>
                            <td  width=15% height="24">OBSERVACIONES</td>
                        </tr>
                            <?while(!$rs->EOF){
